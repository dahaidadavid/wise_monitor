 ...
 * @date 2018/6/5
 */
class WiseContext extends ContextWrapper {

    private final String componentPath;
    private final String componentName;

    public WiseContext(Context base, String componentName, String componentPath) {
        super(base);
    ...
    public SQLiteDatabase openOrCreateDatabase(String name, int mode, CursorFactory factory,
        ...
        return SQLiteDatabase
                .openOrCreateDatabase(this.getDatabasePath(name).getPath(), factory, errorHandler);
    }
